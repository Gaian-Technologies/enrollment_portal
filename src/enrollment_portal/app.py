...
from .models import AccessRequestCreate, HealthResponse
...
def create_app(settings: Settings) -> FastAPI:
    ...
    async def verify_request(request: Request, token: str) -> HTMLResponse:
        try:
            invite = await runtime.verify_request(token)
